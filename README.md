...
## Структура проекта:
- docs/lesson16: содержит в себе документацию проекта.
...
# Utils:
- TestHelper: класс, предоставляющий вспомогательные методы для тестирования. Включает методы для проверки отображения окна cookie, текста элементов на странице. Если проверка проходит, выводится сообщение об успешном тесте. В противном случае выбрасывается AssertionError с описанием ошибки.
...
# Pages:
- HomePage: класс, содержащий в себе методы проверки для выполнения задания 1;
- PaymentPage: класс, содержащий в себе методы проверки для выполнения задания 2.

# Урок #17

## Структура проекта:
- docs/lesson17: содержит в себе документацию проекта.
- src/test/java/lesson17: содержит в себе файлы для запуска тестов по условию задач;

## Где найти техническое задание, содержащие в себе условия задачи?
Условие, где хранится описание задач, содержится в папке docs, папка lesson17, файл TOR.md

## Пометка по выполнению программного кода:
* Запуск тестов производится из пакета lesson17, файл PostmanEchoTests;
* Установленные библиотеки: junit (version 4.13.2), selenium (version 4.24.0), rest-assured(version 5.5.0).

## Java файлы и их описание:

- PostmanEchoTests - класс, содержащий в себе тестирование REST API методов.

# Урок #18

## Структура проекта:
- docs/lesson18: содержит в себе документацию проекта.
- src/test/java/lesson16: содержит в себе файлы для запуска тестов по условию задач;

## Где найти техническое задание, содержащие в себе условия задачи?
Условие, где хранится описание задач, содержится в папке docs, папка lesson18, файл TOR.md

## Пометка по выполнению программного кода:
* Запуск тестов производится из пакета lesson17, файл PostmanEchoTests;
* Установленные библиотеки: junit (version 4.13.2), selenium (version 4.24.0), allure-junit5 (version 2.29.0).
